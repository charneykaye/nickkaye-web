...
include_once('protected/models/Person.php');
include_once('protected/models/Gig.php');
include_once('protected/models/GigGroup.php');
 ...
 * @var Person $person
 */
$person = new Person(require(__DIR__ . '/protected/data/person.php'));
...
<?php /* include(__DIR__.'/protected/views/nav.php'); */ ?>

<?php include(__DIR__ . '/protected/views/jumbotron.php'); ?>

<?php include(__DIR__ . '/protected/views/gigs.php'); ?>

<?php include(__DIR__ . '/protected/views/footer.php'); ?>
